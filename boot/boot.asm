...
dq memory_file_system_start_libc_path
dq memory_file_system_start_libc_end - memory_file_system_start_libc_start
memory_file_system_start_libc_start:
incbin "libc.so.6"
memory_file_system_start_libc_end:
...
dq memory_file_system_start_ls_path
dq memory_file_system_start_ls_end - memory_file_system_start_ls_start
memory_file_system_start_ls_start:
incbin "ls"
memory_file_system_start_ls_end:

dq memory_file_system_start_cat_path
dq memory_file_system_start_cat_end - memory_file_system_start_cat_start
memory_file_system_start_cat_start:
incbin "cat"
...
incbin "libpcre2-8.so.0"
memory_file_system_start_libpcre_end:

dq memory_file_system_start_libselinux_path
dq memory_file_system_start_libselinux_end - memory_file_system_start_libselinux_start
memory_file_system_start_libselinux_start:
incbin "libselinux.so.1"
memory_file_system_start_libselinux_end:
