...
v1 . ./utility/ ./system-calls/ ./file-systems/ ./file-systems/memory-file-system/ ./devices/ ./build/entry.o ./build/cpu.o -binary -o ./build/kernel.bin -base 0xffff800000104000 -system -a
